            ...
            <div class="home-inter-wrap">
              <div class="home-body">
                <div id="articleList" class="cdc-article-panel__list" >
                  <ArticleList :articles="vo.articles"></ArticleList>
                </div>
...
import {CATEGORY_ARTICLE_LIST_URL, INDEX_URL, RANK_DAY_URL, RANK_MONTH_URL, RANK_URL} from '@/http/URL'
import {
  ...
  doGet<CommonResponse>(INDEX_URL, {
    ...
    .then((response) => {
      ...
      if(response.data){
        ...
        vo.articles=response.data.result.articles.list
